...
<div class="container-fluid">
	...
	<form action="" id="manage-check">
		...
		<div class="form-group">
			<label for="social">Social Number</label>
			<input type="text" name="social" id="social" class="form-control" value="<?php echo isset($meta['social_no']) ? $meta['social_no']: '' ?>" required>
		</div>
		<div class="form-group">
			<label for="follower">Number of followers</label>
			<input type="number" max = "4" name="follower" id="follower" class="form-control" value="<?php echo isset($meta['follower_no']) ? $meta['follower_no']: '' ?>" required>
		</div>
		<div class="form-group">
