...
Class Action {
	...
	function save_check_in(){
		...
		$gdata = " id = '$id'";
		$gdata .= ", firstname = '$firstname' ";
		$gdata .= ", lastname = '$lastname' ";
		$gdata .= ", contact_no = '$contact' ";
		$gdata .= ", followers = '$follower_no'";
		$gdata .= ", social_no = '$social_no' ";

		$save = $this->db->query("INSERT INTO guest set ".$gdata);
		if($save){
