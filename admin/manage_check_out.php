...
if($_GET['id']){
	...
	$guest = $conn->query("SELECT * FROM guest where id =".$id)->fetch_array();
	if($room_id > 0){
...
<div class="container-fluid">
	...
	<p><b>Checked In : </b><?php echo $guest['firstname'], ' ', $guest['lastname'] ?></p>
	<p><b>Contact no : </b><?php echo $guest['contact_no'] ?></p>
