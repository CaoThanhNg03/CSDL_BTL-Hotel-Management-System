    ...
    <div class="modal-dialog modal-md" role="document">
      ...
      <div class="modal-footer">
        ...
        <footer class="bg-light py-5">
            <div class="container"><div class="small text-center text-muted">Hotel Mangement system | <a href="https://courses.uet.vnu.edu.vn/my/" target="_blank">Courses UET</a></div></div>
        </footer>
